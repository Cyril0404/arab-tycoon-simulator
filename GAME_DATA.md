...
> ⚠️ 本文档所有数值均已重平衡（v1.1版本）。经济核心原则：**打工为温饱积蓄，资产带来身份，身份解锁更高的赚钱效率**。

### 2.1 三种赚钱方式

| 行为ID | 名称 | 英文名 | 基础收益 | 冷却时间 | 说明 |
|--------|------|--------|----------|----------|------|
| `work` | 打工 | Work | +50 AED | 60 秒 | 稳定温饱，适合新手 |
| `business` | 做生意 | Business | +300 AED | 300 秒（5分钟） | 效率比打工稍高 |
| `invest` | 城市投资 | City Investment | +2,000 AED | 60 秒 | 解锁条件：持有任意城市地块 |
| `oil` | 投资石油 | Oil Investment | +100,000 AED（成功）<br>-50,000 AED（失败） | 7200 秒（2小时） | 50% 概率；石油特权BUFF可将成功率提升至70% |

**设计理念：**
- 打工和做生意不再是"无限刷"，而是**被动等待**积累
- 城市投资是**有地玩家**的专属福利，激励购买地块
- 石油投资2小时CD，降低赌博频率，增加每次决策的重要性
